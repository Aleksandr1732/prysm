...
This document describes the design and architecture of the beacon chain state management packages in Prysm. The state management system implements an immutable, copy-on-write architecture with efficient merkle trie root computation.
